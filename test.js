...
const codCheckout = async (req, res) => {
  try {
    ...
    const orderdata = await Order.findOne({ orderId: placedOrder.orderId });
    console.log("00000000000000000000000000000000000000",orderdata)
    const OrderDetaitlsData = await OrderDetail.findOne({
      orderId: orderdata.orderId,
    });
console.log("7777877777777777777777",OrderDetaitlsData)
    ...
    const courierRequest = async () => {
      try {
        ...
        console.log("3456789034567890-",res.data)
    ...
    try {
      ...
      console.log("234567890999999999",modifyOrderData);
    ...
    console.log("2345678444444444444444444",modifyOrderData);
 ...
 console.log("789000000000000000",updateUserData)
    res.status(200).json({ success: true, modifyOrderData });
  } catch (error) {
    console.log(error.message);
    res.status(201).json({ errorMsg: error.message, success: false });
